...
namespace Game
{
    public class Game
    {
        ...
        private readonly float generationTime = 0.05f;
            ...
            while (window.IsOpen)
            {
                    ...
                    !world.HasConverged)
                {
                    doGeneration = Task.Run(() =>
                    {
                        ...
                        pathScreen.UpdateSequence(world.GetPathVisualizations());
                    ...
                    world.NoImprovementCount == GAConfig.MaxNoImprovementCount)
                {
                    ...
                    Clipboard.Contents = string.Join(",", world.FitnessOverTime);
                }
        ...
        private void ProcessUserInput()
        {
            ...
            // If the T key has been just pressed, toggle the pareto visualisation
            if (KeyboardHelper.IsKeyJustPressed(Keyboard.Key.T))
            {
                world.ToggleVisualizationMode();
            }
        }
